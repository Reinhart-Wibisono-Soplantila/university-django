...
urlpatterns = [
    ...
    path('administrative-staff/', AdministrativeStaffApiView.as_view(), name='admin_staff'),
    path('administrative-staff/<int:nip>', AdministrativeStaffApiView.as_view(), name='admin_staff'),
    path('admin-staff/', SuperAdminStaffApiView.as_view(), name='admin_staff'),
    path('admin-staff/<int:nip>', SuperAdminStaffApiView.as_view(), name='admin_staff'),
